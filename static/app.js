...
// DOM elements will be initialized when the DOM is fully loaded
let tweetFeed;
let tweetContent;
let postTweetBtn;
let sidebarUserInfo;
...
// Main event listener for DOM loaded
document.addEventListener('DOMContentLoaded', function() {
    // Initialize DOM elements only after the DOM is fully loaded
    ...
    // Now that elements are initialized, add event listeners
    if (postTweetBtn) postTweetBtn.addEventListener('click', postTweet);
